...
@section('title', 'التحكم بالموظفين')

@section('users', 'here show')
@section('users_staff', 'active')
...
@section('toolbar')
    ...
    <a href="{{route('admin.users.staff.create')}}" class="btn btn-sm btn-primary">أضافة جديد</a>
@endsection
        ...
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column mb-1">
                <span class="card-label fw-bolder fs-3 mb-1">
                    <i class="fas fa-users fa-fw mx-2"></i>التحكم بالموظفين
                </span>
            </h3>
        </div>
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    @foreach($users as $key => $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('admin.users.staff.edit', $user->userid)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
