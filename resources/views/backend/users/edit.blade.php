                    ...
                    <form action="{{route('admin.users.update', $user->userid)}}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select form-select-solid" name="usergroup" id="usergroup" data-control="select2" data-placeholder="حدد خيار">
                                <option value="1" @if(old('usergroup', $user->usergroup) == 1) selected @endif>عضو</option>
                                <option value="2" @if(old('usergroup', $user->usergroup) == 2) selected @endif>مصلح</option>
                                <option value="3" @if(old('usergroup', $user->usergroup) == 3) selected @endif>موظف</option>
                                <option value="10" @if(old('usergroup', $user->usergroup) == 10) selected @endif>إداري</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
