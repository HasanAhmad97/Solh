...
@section('title', 'تحديد الجلسات للقضايا')

@section('request_session', 'active')
...
@section('toolbar')
    <div class="m-0">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-800px" data-kt-menu="true" id="kt_menu_61de0c0cad61e">
            ...
            <div class="px-7 py-5">
                  <form method="post" action="{{route('admin.request.session.filter')}}">
                    @csrf
                    <input type="hidden" name="filter_type" value = "approved" >
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-10">
                                <label class="form-label fw-bold" for="f_name">الاسم</label>
                                <input type="text" name="name" id="f_name" class="form-control">
                            </div>
                        </div>
                         <div class="col-md-1 align-self-center">أو</div>
                        <div class="col-md-3">
                            <div class="mb-10">
                                <label class="form-label fw-bold" for="f_phone">رقم الهاتف</label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-10">
                                <label class="form-label fw-bold" for="f_id">رقم الهوية </label>
                                <input type="text" name="id" id="f_id" class="form-control">
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column mb-1">
                <span class="card-label fw-bolder fs-3 mb-1">
                    <i class="fas fa-list fa-fw mx-2"></i>طلبات بانتظار تحديد الجلسات
                </span>
                <small class="text-danger d-block">
                    ملاحظة: الطلبات الواردة في هذه الصفحة هي الطلبات المعتمدة أو المعاد جدولتها بواسطة المصلح.
                </small>
            </h3>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="text-muted fw-bold text-muted d-block fs-7">
                                        <a href="tel:{{shortPhone($req->phone_number)}}">{{shortPhone($req->phone_number)}}</a>
                                    </span>
                                </td>
                                <td class="text-center">{{date('Y-m-d', $req->dateadd)}}</td>
                                <td class="text-center">{{ getRequestType($req->req_type) }}</td>
                                <td class="text-center">{!! getRequestStatus($req->status) !!}</td>
                                <td class="text-center">
