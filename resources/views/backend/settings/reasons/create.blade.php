...
@section('title', 'اضافة أسباب القضايا')
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    ...
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <i class="fas fa-plus fa-fw mx-2"></i>اضافة أسباب القضايا
                    </span>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.settings.reasons.store')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" name="default_complainant" id="default_complainant" data-kt-select2="true" data-placeholder="حدد خيار">
                                            ...
                                            <option value="husband" @if(old('default_complainant') == 'husband') selected @endif>الزوج</option>
                                            <option value="wife" @if(old('default_complainant') == 'wife') selected @endif>الزوجة</option>
                                            <option value="husband_agent" @if(old('default_complainant') == 'husband_agent') selected @endif>وكيل الزوج</option>
                                            <option value="wife_agent" @if(old('default_complainant') == 'wife_agent') selected @endif>وكيل الزوجة</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
