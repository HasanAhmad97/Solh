            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    ...
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <i class="fas fa-plus fa-fw mx-2"></i>اضافة جنسية
                    </span>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.settings.nationality.store')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="title_female" id="title_female" class="form-control" value="{{old('title_female')}}">
