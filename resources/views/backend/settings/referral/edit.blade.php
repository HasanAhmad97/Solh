            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    ...
                    <span class="card-label fw-bolder fs-3 mb-1">
                        <i class="fas fa-edit fa-fw mx-2"></i>تعديل جهة
                    </span>
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.settings.referral.update', $referral->referid)}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="title">إسم الجهة</label>
                                    <input type="text" name="title" id="title" class="form-control" value="{{old('title', $referral->title)}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="contact_name" id="contact_name" class="form-control" value="{{old('contact_name', $referral->contact_name)}}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" name="closed" id="closed" data-kt-select2="true" data-placeholder="حدد خيار">
                                            <option value="0" @if(old('closed', $referral->closed) == 0) selected @endif>فعال</option>
                                            <option value="1" @if(old('closed', $referral->closed) == 1) selected @endif>غير فعال</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
